...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4142__auto__,writer__4143__auto__,opt__4144__auto__){return cljs.core._write.call(null,writer__4143__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_20407 = (0);while(true){
if((i_20407 < arr.length))
{(arr[i_20407] = null);
{
var G__20408 = (i_20407 + (1));
i_20407 = G__20408;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4142__auto__,writer__4143__auto__,opt__4144__auto__){return cljs.core._write.call(null,writer__4143__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_20414 = (self__.level + (1));while(true){
if((i_20414 <= (new_level + (1))))
{(update[i_20414] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20416 = (0);while(true){
if((i_20416 <= self__.level))
{var links_20417 = (update[i_20416]).forward;if(((links_20417[i_20416]) === x__$1))
{(links_20417[i_20416] = (x__$1.forward[i_20416]));
{
var G__20418 = (i_20416 + (1));
i_20416 = G__20418;
continue;
}
} else
{{
var G__20419 = (i_20416 + (1));
i_20416 = G__20419;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3575__auto__ = (cljs.core.truth_((function (){var and__3563__auto__ = me;if(cljs.core.truth_(and__3563__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3563__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3575__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__3575__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__3575__auto__,timeout__$1,me))
,msecs);
