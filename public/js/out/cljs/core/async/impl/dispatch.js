...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20500 = (0);while(true){
var m_20501 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20501 == null))
{} else
{m_20501.call(null);
if((count_20500 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20502 = (count_20500 + (1));
count_20500 = G__20502;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3563__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3563__auto__)
