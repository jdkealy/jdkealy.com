...
var url_encode__delegate = function (s,p__17296){var vec__17298 = p__17296;var encoding = cljs.core.nth.call(null,vec__17298,(0),null);if(cljs.core.truth_(s))
...
return url_encode__delegate.call(this,s,p__17296);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__17299){
var s = cljs.core.first(arglist__17299);
var p__17296 = cljs.core.rest(arglist__17299);
return url_encode__delegate(s,p__17296);
});
...
var url_decode__delegate = function (s,p__17300){var vec__17302 = p__17300;var encoding = cljs.core.nth.call(null,vec__17302,(0),null);if(cljs.core.truth_(s))
...
return url_decode__delegate.call(this,s,p__17300);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__17303){
var s = cljs.core.first(arglist__17303);
var p__17300 = cljs.core.rest(arglist__17303);
return url_decode__delegate(s,p__17300);
});
...
{var G__17306 = clojure.string.upper_case.call(null,unit);switch (G__17306) {
default:
var G__17307 = unit;switch (G__17307) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__17310_SHARP_){return parseInt(p1__17310_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__17311_SHARP_){return parseInt(p1__17311_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__17312_SHARP_){return parseFloat(p1__17312_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__17313_SHARP_){return parseFloat(p1__17313_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__17316_SHARP_){return clojure.string.join.call(null,"=",p1__17316_SHARP_);
}),cljs.core.map.call(null,(function (p1__17315_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__17315_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__17315_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__17314_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__17314_SHARP_))));
...
*/
no.en.core.format_url = (function format_url(m){var query_params = new cljs.core.Keyword(null,"query-params","query-params",900640534).cljs$core$IFn$_invoke$arity$1(m);return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__17318 = m;var map__17318__$1 = ((cljs.core.seq_QMARK_.call(null,map__17318))?cljs.core.apply.call(null,cljs.core.hash_map,map__17318):map__17318);var password = cljs.core.get.call(null,map__17318__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.call(null,map__17318__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__17321_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__17321_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__17321_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__17320_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__17320_SHARP_));
}),cljs.core.map.call(null,(function (p1__17319_SHARP_){return clojure.string.split.call(null,p1__17319_SHARP_,/=/);
...
}catch (e17323){if((e17323 instanceof Error))
{var e = e17323;if((n__$1 === (0)))
{throw e;
} else
{return null;
}
