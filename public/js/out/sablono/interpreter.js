...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj20641 = {};return obj20641;
})();
sablono.interpreter.interpret = (function interpret(this$){if((function (){var and__3563__auto__ = this$;if(and__3563__auto__)
...
{var x__4202__auto__ = (((this$ == null))?null:this$);return (function (){var or__3575__auto__ = (sablono.interpreter.interpret[goog.typeOf(x__4202__auto__)]);if(or__3575__auto__)
{return or__3575__auto__;
} else
{var or__3575__auto____$1 = (sablono.interpreter.interpret["_"]);if(or__3575__auto____$1)
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__20643 = sablono.util.normalize_element.call(null,element__$1);var tag = cljs.core.nth.call(null,vec__20643,(0),null);var attrs = cljs.core.nth.call(null,vec__20643,(1),null);var content = cljs.core.nth.call(null,vec__20643,(2),null);var f = sablono.interpreter.dom_fn.call(null,tag);var js_attrs = sablono.interpreter.attributes.call(null,attrs);if((cljs.core.sequential_QMARK_.call(null,content)) && (cljs.core._EQ_.call(null,(1),cljs.core.count.call(null,content))))
